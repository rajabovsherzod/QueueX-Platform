...
import { superAdminLoginSchema, createCompanyFormDataSchema, updateCompanySchema, companyIdSchema} from "./superadmin.validator";
...
import { validateFormData } from "@/shared/middlewares/validateFormData.middleware";
...
router.post("/companies", uploadLogo, handleUploadError, validateFormData(createCompanyFormDataSchema), superAdminController.createCompany)
